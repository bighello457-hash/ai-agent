...
import com.fxs.aiagent.prompt.SystemPrompt;
...
//    public ToolCallback[] allTools;
    ...
    private static final String SYSTEM_PROMPT = SystemPrompt.offerPilotSystemPrompt;

    public OfferPilot(ChatClient.Builder builder) {
        chatClient = builder
